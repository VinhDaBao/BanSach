...
//
//        return  sachRepository.getTopSellingBooks(pageable);
//
//    }
//
//    @Override
//    public Map<String, Object> getTopSellingBook() {
//        List<Map<String, Object>> top = getTopSellingBooks(1);
//        return top.isEmpty() ? null : top.get(0);
//    }
//
//    @Override
//    public List<Map<String, Object>> getDetailedStockReport() {
//        return sachRepository.getDetailedStockReport();
//    }
//
//    @Override
//    public List<Map<String, Object>> getStockReport() {
//        return sachRepository.getStockReport();
//    }
//
//    public KhuyenMai getBestKhuyenMai(int maSach) {
//        Optional<Sach> sachOpt = sachRepository.findById(maSach);
//        if (sachOpt.isEmpty()) return null;
...
//	@Override
//	public List<Sach> findAllDangKinhDoanh() {
//		return sachRepository.findAllDangKinhDoanh();
//	}
...
//			String status) {
//
//		List<Object[]> list = sachRepository.getTopSellingBooksInRange(from, to, status);
//		List<Map<String, Object>> data = new ArrayList<>();
//
//		int count = 0;
//		for (Object[] row : list) {
//			if (count++ >= limit)
//				break; // Giới hạn số lượng kết quả
//			data.add(Map.of("tenSach", row[0], "tacGia", row[1], "soLuongBan", row[2]));
//		}
//		return data;
//	}
...
//	@Override
//	public List<Map<String, Object>> getTopSellingBooks(int limit) {
//	    // Lấy toàn bộ thời gian (từ 1970 đến nay) và chỉ tính các đơn "Đã xác nhận"
//	    LocalDateTime from = LocalDateTime.of(1970, 1, 1, 0, 0);
//	    LocalDateTime to = LocalDateTime.now();
//	    String status = "Đã xác nhận";
//
...
//	    for (Object[] row : raw) {
//	        if (count++ >= limit)
//	            break; // áp limit thủ công
//	        Map<String, Object> m = new HashMap<>();
//	        m.put("tenSach", row[0]);
//	        m.put("tacGia", row[1]);
//	        m.put("soLuongBan", row[2]);
//	        result.add(m);
//	    }
//	    return result;
//	}
...
//	@Override
//	public List<Map<String, Object>> getRevenueByCategoryInRange(LocalDateTime from, LocalDateTime to, String status) {
//		List<Object[]> results = sachRepository.getRevenueByCategoryInRange(from, to, status);
//		List<Map<String, Object>> list = new ArrayList<>();
//		for (Object[] row : results) {
//			Map<String, Object> map = new HashMap<>();
//			map.put("theLoai", row[0]);
//			map.put("tongTien", row[1]);
//			list.add(map);
//		}
//		return list;
//	}
